...
var wasmBinaryFile = 'hackrf_clock.wasm';
...
var ASM_CONSTS = {
 ...
 5466: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);},  
 5568: function() {return TOTAL_STACK}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=9440;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        var pthreadMainJs = locateFile('hackrf_clock.worker.js');
