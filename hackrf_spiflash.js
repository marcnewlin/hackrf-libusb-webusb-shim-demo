...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 1059008,
    DYNAMIC_BASE = 6301888,
    DYNAMICTOP_PTR = 1058080;
...
var wasmBinaryFile = 'hackrf_spiflash.wasm';
...
var ASM_CONSTS = {
  2624: function() {return _get_vid();},  
 2647: function() {return _get_pid();},  
 6330: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);},  
 6432: function() {return TOTAL_STACK}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=1058992;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 1058240;
        ...
        var pthreadMainJs = locateFile('hackrf_spiflash.worker.js');
