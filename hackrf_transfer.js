...
var wasmBinaryFile = 'hackrf_transfer.wasm';
...
var ASM_CONSTS = {
  2686: function($0, $1, $2, $3) {return _submit_bulk_in_transfer($0, $1, $2, $3);},  
 2739: function($0, $1, $2, $3) {return _submit_bulk_out_transfer($0, $1, $2, $3);},  
 2793: function() {return _get_vid();},  
 2816: function() {return _get_pid();},  
 8824: function() {throw 'Canceled!'},  
 9044: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);},  
 9146: function() {return TOTAL_STACK}
};

function _emscripten_asm_const_sync_on_main_thread_iii(code, sigPtr, argbuf) {
  if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_proxy_to_main_thread_js(-1 - code, 1, code, sigPtr, argbuf); }
...
function _emscripten_asm_const_iii(code, sigPtr, argbuf) {
  var args = readAsmConstArgs(sigPtr, argbuf);
  return ASM_CONSTS[code].apply(null, args);
}function claim_interface(interface_number){ return _claim_interface(interface_number); }
function close_device(){ return _close_device(); }
function control_transfer(request_type,bRequest,wValue,wIndex,data,wLength,timeout){ return _control_transfer(request_type, bRequest, wValue, wIndex, data, wLength, timeout); }
function ensure_navigator_usb(){ return navigator.usb !== undefined; }
function get_active_config_descriptor(){ return _get_active_config_descriptor(); }
function get_configuration(){ return _get_configuration(); }
function get_device_descriptor(desc){ return _get_device_descriptor(desc); }
function get_string_descriptor(desc_index,data,length){ return _get_string_descriptor(desc_index, data, length); }
function initPthreadsJS(){ PThread.initRuntime(); }
function open_device(){ return _open_device(); }
function open_device_with_vid_pid(vid,pid){ return _open_device_by_vid_pid(vid, pid); }
function release_interface(interface_number){ return _release_interface(interface_number); }



// STATICTOP = STATIC_BASE + 13424;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=14432;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        var pthreadMainJs = locateFile('hackrf_transfer.worker.js');
  ...
  var ___tm_current=13536;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 13584, 4), 13584);
  ...
  function runAndAbortIfError(func) {
      try {
        ...
        var ASYNCIFY_IMPORTS = ["env.request_device_access","env.open_device","env.open_device_with_vid_pid","env.close_device","env.claim_interface","env.release_interface","env.control_transfer","env.emscripten_receive_on_main_thread_js","env.emscripten_asm_const_iii","env.invoke_*","env.__call_main","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await"].map(function(x) {
          return x.split('.')[1];
        });
...
var proxiedFunctionTable = [null,___sys_fcntl64,___sys_ioctl,___sys_open,_emscripten_set_canvas_element_size_main_thread,_fd_close,_fd_read,_fd_seek,_fd_write,_tzset];
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__call_main": ___call_main, "__clock_gettime": ___clock_gettime, "__handle_stack_overflow": ___handle_stack_overflow, "__sys_fcntl64": ___sys_fcntl64, "__sys_ioctl": ___sys_ioctl, "__sys_open": ___sys_open, "_emscripten_notify_thread_queue": __emscripten_notify_thread_queue, "claim_interface": claim_interface, "close_device": close_device, "control_transfer": control_transfer, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_asm_const_sync_on_main_thread_iii": _emscripten_asm_const_sync_on_main_thread_iii, "emscripten_conditional_set_current_thread_status": _emscripten_conditional_set_current_thread_status, "emscripten_futex_wait": _emscripten_futex_wait, "emscripten_futex_wake": _emscripten_futex_wake, "emscripten_get_now": _emscripten_get_now, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_has_threading_support": _emscripten_has_threading_support, "emscripten_is_main_browser_thread": _emscripten_is_main_browser_thread, "emscripten_is_main_runtime_thread": _emscripten_is_main_runtime_thread, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_receive_on_main_thread_js": _emscripten_receive_on_main_thread_js, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_canvas_element_size": _emscripten_set_canvas_element_size, "emscripten_set_current_thread_status": _emscripten_set_current_thread_status, "emscripten_set_thread_name": _emscripten_set_thread_name, "emscripten_sleep": _emscripten_sleep, "emscripten_webgl_create_context": _emscripten_webgl_create_context, "ensure_navigator_usb": ensure_navigator_usb, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "get_active_config_descriptor": get_active_config_descriptor, "get_configuration": get_configuration, "get_device_descriptor": get_device_descriptor, "get_string_descriptor": get_string_descriptor, "gettimeofday": _gettimeofday, "initPthreadsJS": initPthreadsJS, "localtime": _localtime, "memory": wasmMemory, "open_device": open_device, "open_device_with_vid_pid": open_device_with_vid_pid, "pthread_cleanup_push": _pthread_cleanup_push, "pthread_create": _pthread_create, "pthread_join": _pthread_join, "pthread_self": _pthread_self, "release_interface": release_interface, "setTempRet0": _setTempRet0, "signal": _signal, "strftime": _strftime, "table": wasmTable, "time": _time };
...
/** @type {function(...*):?} */
var _libusb_exit = Module["_libusb_exit"] = createExportWrapper("libusb_exit");
